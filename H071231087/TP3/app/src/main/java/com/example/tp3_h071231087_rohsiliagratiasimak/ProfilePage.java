...
public class ProfilePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user.getUsername().equals("roses_are_rosie")) {
        ...
        PostGridAdapter postGridAdapter = new PostGridAdapter(this, PostDataSource.generateDummyPostProfilePage(username), username);
